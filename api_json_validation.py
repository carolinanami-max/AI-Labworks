...
def demonstrate_validation():
    """Demonstrate JSON validation with examples."""
    print("\n" + "="*60)
    print("DEMONSTRATION: JSON VALIDATION")
    print("="*60)
    ...
    print("\nSample JSON files created in 'json_samples/' folder")
    
    # Demonstrate validation
    print("\n" + "-"*60)
    print("Testing valid_product.json:")
    result1 = validate_json_file("json_samples/valid_product.json")
    
    print("\n" + "-"*60)
    print("Testing invalid_product.json:")
    result2 = validate_json_file("json_samples/invalid_product.json")
...
def demonstrate_complete_workflow():
    ...
    print("\n" + "="*60)
    print("DEMONSTRATION: COMPLETE WORKFLOW")
    print("="*60)
...
if __name__ == "__main__":
    ...
    print("\nStarting Lab M1.06 Demonstration...")
    
    # Part A: Show validation
    valid_result, invalid_result = demonstrate_validation()
    
    # Part B: Show complete workflow (if API key is available)
    try:
        load_dotenv()
        if os.getenv("OPENAI_API_KEY"):
            ...
            print("\n" + "="*60)
            print("Note: OpenAI API key not found.")
            print("Complete workflow demonstration requires API key in .env file")
            print("="*60)
    except Exception as e:
        print(f"\nWorkflow demonstration skipped: {e}")
    
    print("\n" + "="*60)
    print("LAB M1.06 DEMONSTRATION COMPLETE")
    print("="*60)